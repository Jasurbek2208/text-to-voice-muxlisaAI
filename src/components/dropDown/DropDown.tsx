  ...
  return (
    <div className="group relative">
      <button
        ...
        ref={buttonRef}
        onClick={toggleMenu}
        className="flex items-center justify-center ml-auto text-gray-600 dark:text-gray-300 rotate-90 outline-none duration-300 focus:scale-105"
      >
        <svg
          className="w-6 h-6"
          aria-hidden="true"
      ...
      {isMenuOpen && (
        <div className="absolute left-3 bottom-11 shadow-xl" ref={dropdownRef}>
          <div
            ...
            className="flex flex-col justify-end py-1 space-y-2 w-48 bg-white border border-gray-100 rounded-lg rounded-bl-none shadow-sm dark:border-gray-600 dark:bg-gray-700 duration-300"
          >
